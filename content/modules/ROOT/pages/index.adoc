...
* VM SSH access: `virtctl ssh cloud-user@rhel-webserver -n default` (uses bastion SSH keys; run the deploy script from the bastion). Wait 5–10 minutes after the VM is Running for cloud-init to complete.
